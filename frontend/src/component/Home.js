...
const Home = () => {
   ...
   return (
      <>
            ...
            <Carousel>
               ...
               <Carousel.Item>
                  <img
                     ...
                     style={{ "height": 510 }}
                     type="button"
                     onClick={() => { setService("Electronic devices") }}

                  />

                  <Carousel.Caption>
                     <a href="" onClick={() => { setService("Electronic devices") }} >     <p className='electronicHeader'> Electronic devices</p>
                     </a>
                  </Carousel.Caption>
               </Carousel.Item>
               <Carousel.Item>
               ...
               <div className="row">
                  ...
                  <div className="col-md-6 offset-md-1">
                     <div className="full text_align_center">
                        <img className="img-responsive" src={about} alt="#" />
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div className="container">
               ...
               <div className="grid-container">
                  <div className="col-md-8 service_blog">
                     <a href="" onClick={() => { setService("Air condition") }}>  
                      <img id="air" class="img-responsive"  style={{ "height": 300 ,"width":900 }} src={air} /> </a>
                     <h4 id="1" >Air Conditioning</h4>
                    
                  </div>

                  <div className="col-md-8 service_blog">
                     <a href="" onClick={() => { setService("Electrical") }}>
                        <img className=" img-responsive" src={electrical2} style={{ "height": 300 ,"width":900 }}  />
                  ...
                  <div className="col-md-8 service_blog">
                     <a href="" onClick={() => { setService("Electronic devices") }} >
                        <img className=" img-responsive" src={electronic} style={{ "height": 300 ,"width":900 }}/>
                  ...
                  <div className="col-md-8 service_blog">
                     <a href="" onClick={() => { setService("Sterilization") }} >
                        <img className="margin_top_10 img-responsive" src={Sterilization} style={{ "height": 300 ,"width":900 }}/>
         ...
         <div id="wcs" className="hiw_section layout_padding">
            <div className="container">
               <div className="row">
                  <div className="col-md-12 text_align_center">
                     <h3 id='review_h3'>Our Client Say</h3>
                  </div>
                  <div className="col-md-5">
                  </div>
               </div>
                  ...
                  return (<>
                     <div className="row">
                        <div className="col-md-11">
                           <div className="full testimonial_blog">
               ...
               <div id="submitReviw" className="row" style={{ display: "none" }}>
                     ...
                     <div className="row">
                        <div className="col-md-11">
                           <div className="full testimonial_blog">
                              <div className="row mt-3 mx-4">
                                 <div className="col-12">
                                    <label className="order-form-label" for="date-picker-example" style={{"color":"white"}}>Selcet the Maintanance Service</label>
                                 </div>
                                 <div className="col-12">
                                    <select className="custom-select my-1 mr-sm-2" id="inlineFormCustomSelectPref" onChange={selectService}>
                              ...
                              <div className="row mt-3 mx-4">
                                 <div className="col-12">
                                    <label className="order-form-label" for="date-picker-example" style={{"color":"white"}}>comments</label>
                                 </div>
                                 <div className="col-12">
                                    <textarea className="order-form-input datepicker" placeholder="write you comment here" type="text-area"
